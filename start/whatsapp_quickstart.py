...
# --------------------------------------------------------------
# Send a buttons WhatsApp message
# --------------------------------------------------------------

# from python_whatsapp_bot import Whatsapp
# from python_whatsapp_bot import Inline_keyboard 
# wa_bot = Whatsapp(number_id=PHONE_NUMBER_ID, token=ACCESS_TOKEN)
# wa_bot.send_message('263715775261', 'Are you a Shipper or Transporter',reply_markup=Inline_keyboard(['Shipper', 'Transporter']))
...
# data = get_text_message_input(
#     recipient=RECIPIENT_WAID, text="Hello, Simba is a test message."
# )
